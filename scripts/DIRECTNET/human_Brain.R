...
data_input_path <- "human_Brain_atac-seq/"
data_output_path <- "human_Brain_atac-seq_output/"
...
genome_info <- read.table(
  file = paste0(
    data_input_path, "hg38.promoter.regions.txt"
  )
)
