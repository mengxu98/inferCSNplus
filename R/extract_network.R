...
#' @param network_links Links obtained by extract_links
...
#'
#' @export
extract_cre.gene.links <- function(
    network_table,
    markers,
    filter = FALSE) {
...
#'
#' @export
extract_peak.tf.links <- function(
    peaks_bed_list,
    species,
    genome,
    markers) {
...
extract_network <- function(
  ...
  cre_gene <- extract_cre.gene.links(
    network_table,
  ...
  cre_tf_list <- extract_peak.tf.links(
  ...
  promoter_cre_tf_list <- extract_peak.tf.links(
